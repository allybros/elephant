...
import com.allybros.elephant_todo_app.ui.screen.main.MainActivity
import com.allybros.elephant_todo_app.ui.screen.main.MainRepository
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun deviceBootCompletedActions(context: Context?) {
        GlobalScope.launch {
            repository.date = GregorianCalendar.getInstance().getFormattedDate()
